...
namespace AngryBee.AI
{
    public class AI_hanpuku_SF
    {
        ...
        Player Search(int time, in (int DestX, int DestY)[] WayEnumerator, in ColoredBoardSmallBigger MeBoard, in ColoredBoardSmallBigger EnemyBoard, in Player Me, in Player Enemy, in sbyte[,] ScoreBoard)
        {
            ...
            {
                Search_A1(cnt, WayEnumerator, MeBoard, EnemyBoard, Me, Enemy, int.MinValue, int.MaxValue, ScoreBoard, time);
                ...
                Search_A2(cnt, WayEnumerator, nMeBoard, nEnBoard, nMe, Enemy, int.MinValue, int.MaxValue, ScoreBoard, time);
        ...
        public Tuple<int, ColoredBoardSmallBigger, ColoredBoardSmallBigger, Player, Player> Search_A1(int deepness, in (int DestX, int DestY)[] WayEnumerator, in ColoredBoardSmallBigger MeBoard, in ColoredBoardSmallBigger EnemyBoard, in Player Me, in Player Enemy, int alpha, int beta, in sbyte[,] ScoreBoard, int time)
        {
            if (deepness == 0)
            {
                ends++;
            ...
            if (alpha == int.MinValue && dp1[deepness].score != int.MinValue)
            {
                ...
                if (movable.IsMovable)
                {
                    if (movable.IsEraseNeeded)
                    {
                        ...
                        result = Search_A1(deepness-1, WayEnumerator, newMeBoard, newEnBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                    }
                    else
                    {
                        newMeBoard[newMe.Agent1] = true;

                        result = Search_A1(deepness-1, WayEnumerator, newMeBoard, EnemyBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                    }
                }
            ...
            for (int i = 0; i < WayEnumerator.Length; ++i)
            {
                ...
                if (movable.IsEraseNeeded)
                {
                    ...
                    cache = Search_A1(deepness - 1, WayEnumerator, newMeBoard, newEnBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                }
                else
                {
                    newMeBoard[newMe.Agent1] = true;

                    cache = Search_A1(deepness - 1, WayEnumerator, newMeBoard, EnemyBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                }
        ...
        public Tuple<int, ColoredBoardSmallBigger, ColoredBoardSmallBigger, Player, Player> Search_A2(int deepness, in (int DestX, int DestY)[] WayEnumerator, in ColoredBoardSmallBigger MeBoard, in ColoredBoardSmallBigger EnemyBoard, in Player Me, in Player Enemy, int alpha, int beta, in sbyte[,] ScoreBoard, int time)
        {
            if (deepness == 0)
            {
                ends++;
            ...
            if (alpha == int.MinValue && dp2[deepness].score != int.MinValue)
            {
                ...
                if (movable.IsMovable)
                {
                    if (movable.IsEraseNeeded)
                    {
                        ...
                        result = Search_A2(deepness - 1, WayEnumerator, newMeBoard, newEnBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                    }
                    else
                    {
                        newMeBoard[newMe.Agent2] = true;

                        result = Search_A2(deepness - 1, WayEnumerator, newMeBoard, EnemyBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                    }
                }
            ...
            for (int i = 0; i < WayEnumerator.Length; ++i)
            {
                ...
                if (movable.IsEraseNeeded)
                {
                    ...
                    cache = Search_A2(deepness - 1, WayEnumerator, newMeBoard, newEnBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                }
                else
                {
                    newMeBoard[newMe.Agent2] = true;

                    cache = Search_A2(deepness - 1, WayEnumerator, newMeBoard, EnemyBoard, newMe, Enemy, result.Item1, beta, ScoreBoard, time);
                }
